...
public class qrcode_print_DB {
    ...
    String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + " (" + qrb00 + " INTEGER," + qrb01 + " TEXT," + qrb02 + " TEXT," + qrb03 + " INTEGER," + qrb04 + " TEXT," + qrb05 + " TEXT," + " PRIMARY KEY(qrb00))";
    ...
    public void append(int xqrb00, String xqrb01, String xqrb02, Integer xqrb03, String xqrb04) {
        try {
    ...
    public void recal(Integer g_cnt, Integer tt_slpb, Integer slpb) {
        String code ;
        Integer g_cnt_t = 0 , tt_slpb_t = 0;
